...
from esphome.components.cc2500 import CONF_CC2500_ID, CC2500

DEPENDENCIES = ["cc2500"]
CODEOWNERS = ["@rrooggiieerr"]

livingcolors1_ns = cg.esphome_ns.namespace("livingcolors1")
LivingColors1 = livingcolors1_ns.class_("LivingColors1", cg.Component)
...
CONFIG_SCHEMA = cv.Schema(
    {
        ...
        cv.GenerateID(CONF_CC2500_ID): cv.use_id(CC2500),
    }
