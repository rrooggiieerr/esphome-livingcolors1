...
//	void dump_config() override;
	bool receive(uint8_t *data, uint8_t length, float rssi, uint8_t lqi) override;
...
public:
	...
	virtual bool receive(uint64_t address, uint8_t *data, uint8_t length, float rssi, uint8_t lqi) {
